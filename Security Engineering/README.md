...
|          모델           | 보호 대상 |            특징            |            설명            |
| :---------------------: | :-------: | :------------------------: | :------------------------: |
| **Bell-LaPadula** (BLP) |  기밀성   |     비인가된 읽기 금지     | No read up / No write down |
|        **Biba**         |  무결성   |     비인가된 기록 금지     | No write up / No read down |
|  **Clark-Wilson** (CW)  |  무결성   |        무결성 보존         |   무결성 등급 격자 사용    |
|    **Chinese Wall**     |  무결성   | 주체 동작에 따른 접근 통제 |       이해 충돌 방지       |
